...
class StationsHistoryApi
{
    ...
    public function getStationHistoryWithHttpInfo($station_id, $start = null, $end = null, string $contentType = self::contentTypes['getStationHistory'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AzuraCast\Model\ApiDetailedSongHistory[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AzuraCast\Model\ApiDetailedSongHistory[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AzuraCast\Model\ApiDetailedSongHistory[]', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AzuraCast\Model\ApiDetailedSongHistory[]',
