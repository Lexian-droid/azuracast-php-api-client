 ...
 */
class ApiStationSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Api_StationSchedule';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for this schedule entry.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of this schedule entry.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Either the playlist or streamer's display name.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The full name of the type and name combined.
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param string|null $start The start time of the schedule entry, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end The start time of the schedule entry, in ISO 8601 format.
     *
     * @return self
     */
