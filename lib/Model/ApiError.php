...
class ApiError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Api_Error';
    ...
    */
     ...
     * Sets code
     *
     * @param int|null $code The numeric code of the error.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The programmatic class of error.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message The text description of the error.
     *
     * @return self
     */
     ...
     * Sets extra_data
     *
     * @param array<string,mixed>|null $extra_data Stack traces and other supplemental data.
     *
     * @return self
     */
     ...
     * Sets success
     *
     * @param bool|null $success Used for API calls that expect an \\Entity\\Api\\Status type response.
     *
     * @return self
     */
